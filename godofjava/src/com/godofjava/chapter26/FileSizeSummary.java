...
public class FileSizeSummary {
	...
	public static void main(String[] args) {		
		...
		String path = "D:\\7.Study\\1.Programming\\7.java\\1.GodOfJava\\text";
	...
	public void printInfo(String path, long fileLength, boolean dirFlag) {
		...
		System.out.println(path + "=" + converFileLength(fileLength) + "(" + fileLength + ")");
	}
	...
	public String converFileLength(long fileLength) {
		if(fileLength < KB) {
			return fileLength + " b";
