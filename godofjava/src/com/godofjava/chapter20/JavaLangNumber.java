...
public class JavaLangNumber {
	...
	public void integerMinMaxCheckBinary() {
		...
		System.out.println("Integer BINARY HEX min=" + Integer.toHexString(Integer.MIN_VALUE));
		System.out.println("Integer BINARY HEX max=" + Integer.toHexString(Integer.MAX_VALUE));
	}
}
